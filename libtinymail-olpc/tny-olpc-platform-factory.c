...
tny_olpc_platform_factory_new_account_store (TnyPlatformFactoryIface *self)
{
	return TNY_ACCOUNT_STORE_IFACE (tny_olpc_account_store_new ());
}

static TnyDeviceIface*
tny_olpc_platform_factory_new_device (TnyPlatformFactoryIface *self)
{
	return TNY_DEVICE_IFACE (tny_olpc_device_new ());
}

static TnyMsgViewIface*
tny_olpc_platform_factory_new_msg_view (TnyPlatformFactoryIface *self)
{
 ...
 *
 *
 * Return value: The #TnyPlatformFactoryIface singleton instance implemented for OLPC
 **/
