...
struct _TnyAccountStoreIface {
	...
	gboolean (*alert_func) (TnyAccountStore *self, TnyAlertType type, const GError *error);
...
gboolean tny_account_store_alert (TnyAccountStore *self, TnyAlertType type, const GError *error);
