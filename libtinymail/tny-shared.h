...
typedef struct _TnyFolderIfaceClass TnyFolderIfaceClass;
typedef struct _TnyHeaderIface TnyHeaderIface;
typedef struct _TnyHeaderIfaceClass TnyHeaderIfaceClass;
typedef struct _TnyMimePartIface TnyMimePartIface;
typedef struct _TnyMimePartIfaceClass TnyMimePartIfaceClass;
...
typedef struct _TnyHeaderProxy TnyHeaderProxy;
