...
typedef struct _TnyPlatformFactoryIface PlatformFactoryIface;
typedef struct _PlatformFactoryIfaceClass PlatformFactoryIfaceClass;
typedef gchar* (*TnyGetPassFunc) (TnyAccountIface *self, const gchar *prompt);
