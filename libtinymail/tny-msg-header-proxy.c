...
static const gchar*
tny_msg_header_proxy_get_uid (TnyMsgHeaderIface *self)
{
	TnyMsgHeader *real = TNY_MSG_HEADER_PROXY (self)->real;
	...
	return tny_msg_header_iface_get_uid (TNY_MSG_HEADER_IFACE(real));
}
...
static void
tny_msg_header_proxy_set_uid (TnyMsgHeaderIface *self, const gchar *id)
{
	TnyMsgHeader *real = TNY_MSG_HEADER_PROXY (self)->real;
	...
	tny_msg_header_iface_set_uid (TNY_MSG_HEADER_IFACE (real), id);
...
tny_msg_header_iface_init (gpointer g_iface, gpointer iface_data)
{
	...
	klass->get_uid_func = tny_msg_header_proxy_get_uid;
	klass->set_uid_func = tny_msg_header_proxy_set_uid;
