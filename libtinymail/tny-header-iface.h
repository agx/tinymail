#ifndef TNY_HEADER_IFACE_H
#define TNY_HEADER_IFACE_H
...
#define TNY_TYPE_HEADER_IFACE             (tny_header_iface_get_type ())
#define TNY_HEADER_IFACE(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), TNY_TYPE_HEADER_IFACE, TnyHeaderIface))
#define TNY_HEADER_IFACE_CLASS(vtable)    (G_TYPE_CHECK_CLASS_CAST ((vtable), TNY_TYPE_HEADER_IFACE, TnyHeaderIfaceClass))
#define TNY_IS_HEADER_IFACE(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), TNY_TYPE_HEADER_IFACE))
#define TNY_IS_HEADER_IFACE_CLASS(vtable) (G_TYPE_CHECK_CLASS_TYPE ((vtable), TNY_TYPE_HEADER_IFACE))
#define TNY_HEADER_IFACE_GET_CLASS(inst)  (G_TYPE_INSTANCE_GET_INTERFACE ((inst), TNY_TYPE_HEADER_IFACE, TnyHeaderIfaceClass))
