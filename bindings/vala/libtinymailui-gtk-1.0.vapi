/* libtinymailui-gtk-1.0.vapi generated by lt-vapigen, do not modify. */
...
namespace Tny {
	...
	public class GtkHeaderListModel : GLib.Object, Gtk.TreeModel, Tny.List {
		...
		public static int received_date_sort_func (Gtk.TreeModel model, out Gtk.TreeIter a, out Gtk.TreeIter b, pointer user_data);
		public static int sent_date_sort_func (Gtk.TreeModel model, out Gtk.TreeIter a, out Gtk.TreeIter b, pointer user_data);
	...
	public class GtkMsgView : Gtk.Bin, Atk.Implementor, Gtk.Buildable, Tny.MimePartView, Tny.MsgView {
		...
		public void get_status_callback (out Tny.StatusCallback status_callback, pointer status_user_data);
		public GtkMsgView ();
