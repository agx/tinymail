...
{
	klass->on_connect_func = tny_camel_default_connection_policy_on_connect;
	klass->on_connection_broken_func = tny_camel_default_connection_policy_on_connection_broken;
	klass->on_disconnect_func = tny_camel_default_connection_policy_on_disconnect;
	klass->set_current_func = tny_camel_default_connection_policy_set_current;
}
