 ...
 **/
gssize 
tny_stream_camel_write_to_stream (TnyStreamCamel *self, TnyStreamIface *output)
{
 ...
 **/
void
tny_stream_camel_set_stream (TnyStreamCamel *self, TnyStreamIface *stream)
{
 ...
 **/
CamelStream *
tny_stream_camel_new (TnyStreamIface *stream)
{
