...
{
	return TNY_CAMEL_BS_MSG_GET_CLASS (self)->get_folder_func (self);
}
...
{
	return TNY_CAMEL_BS_MSG_GET_CLASS (self)->get_header_func (self);
}
...
{
	return TNY_CAMEL_BS_MSG_GET_CLASS (self)->get_url_string_func (self);
}
...
{
	TNY_CAMEL_BS_MSG_GET_CLASS (self)->rewrite_cache_func (self);
	return;
}
...
{
	TNY_CAMEL_BS_MSG_GET_CLASS (self)->uncache_attachments_func (self);
}
...
tny_msg_init (gpointer g, gpointer iface_data)
{
	...
	klass->get_header_func = tny_camel_bs_msg_get_header;
	klass->get_folder_func = tny_camel_bs_msg_get_folder;
	klass->get_url_string_func = tny_camel_bs_msg_get_url_string;
	klass->uncache_attachments_func = tny_camel_bs_msg_uncache_attachments;
	klass->rewrite_cache_func = tny_camel_bs_msg_rewrite_cache;
...
tny_camel_bs_msg_class_init (TnyCamelBsMsgClass *class)
{
	...
	class->get_header_func = tny_camel_bs_msg_get_header_default;
	class->get_folder_func = tny_camel_bs_msg_get_folder_default;
	class->get_url_string_func = tny_camel_bs_msg_get_url_string_default;
	class->uncache_attachments_func = tny_camel_bs_msg_uncache_attachments_default;
	class->rewrite_cache_func = tny_camel_bs_msg_rewrite_cache_default;
