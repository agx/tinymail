...
{
	return TNY_CAMEL_BS_MSG_RECEIVE_STRATEGY_GET_CLASS (self)->perform_get_msg_func (self, folder, header, err);
}
...
{
	klass->perform_get_msg_func = tny_camel_bs_msg_receive_strategy_perform_get_msg;
}
...
tny_camel_bs_msg_receive_strategy_class_init (TnyCamelBsMsgReceiveStrategyClass *klass)
{
	...
	klass->perform_get_msg_func = tny_camel_bs_msg_receive_strategy_perform_get_msg_default;
