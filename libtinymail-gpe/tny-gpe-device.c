...
static void tny_gpe_device_on_online (TnyDeviceIface *self);
static void tny_gpe_device_on_offline (TnyDeviceIface *self);
static gboolean tny_gpe_device_is_online (TnyDeviceIface *self);


static void 
tny_gpe_device_reset (TnyDeviceIface *self)
{
...
static void 
tny_gpe_device_force_online (TnyDeviceIface *self)
{
	TnyGpeDevicePriv *priv = TNY_GPE_DEVICE_GET_PRIVATE (self);
...
static void
tny_gpe_device_force_offline (TnyDeviceIface *self)
{
	TnyGpeDevicePriv *priv = TNY_GPE_DEVICE_GET_PRIVATE (self);
...
static void
tny_gpe_device_on_online (TnyDeviceIface *self)
{
...
static void
tny_gpe_device_on_offline (TnyDeviceIface *self)
{
...
static gboolean
tny_gpe_device_is_online (TnyDeviceIface *self)
{
	TnyGpeDevicePriv *priv = TNY_GPE_DEVICE_GET_PRIVATE (self);
