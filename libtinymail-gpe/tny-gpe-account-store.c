...
static gboolean
tny_gpe_account_store_alert (TnyAccountStore *self, TnyAlertType type, gboolean question, const GError *error)
{
...
tny_account_store_init (gpointer g, gpointer iface_data)
{
	...
	klass->find_account_func = tny_gpe_account_store_find_account;
