...
#define TNY_GTK_FOLDER_STORE_TREE_MODEL_GET_CLASS(inst)  (G_TYPE_INSTANCE_GET_INTERFACE ((inst), TNY_TYPE_GTK_FOLDER_STORE_TREE_MODEL, TnyGtkFolderStoreTreeModelClass))
...
typedef enum _TnyGtkFolderStoreTreeModelColumnType TnyGtkFolderStoreTreeModelColumnType;
