...
static gboolean 
tny_attach_list_model_iterator_has_next (TnyIteratorIface *self)
{
	TnyAttachListModelIterator *me = (TnyAttachListModelIterator*) self;
	gboolean retval;
...
static gboolean 
tny_attach_list_model_iterator_has_first (TnyIteratorIface *self)
{
	TnyAttachListModelIterator *me = (TnyAttachListModelIterator*) self;
	gboolean retval;
...
tny_iterator_iface_init (TnyIteratorIfaceClass *klass)
{
	...
	klass->has_first_func = tny_attach_list_model_iterator_has_first;
	klass->has_next_func = tny_attach_list_model_iterator_has_next;
